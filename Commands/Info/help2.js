...
module.exports = {
  ...
  run: async (client, message, args) => {
    let embed = new Discord.MessageEmbed()
      ...
      .addField("<a:ec:932741900623040522> Economy Commands:", "`work`, `beg`, `rob`, `pay`, `balance`, `profile`, `withdraw`, `deposit`, `daily`, `weekly`, `store`, `buy`, `sell`, `roulette`, `slots`, `storeinfo [item]`")
