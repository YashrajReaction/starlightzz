...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    .setColor("#FFFFFF")
    .setDescription(`${crossemoji} You need 2000 coins to purchase Bronze VIP`);
        ...
        .setColor("#FFFFFF")
        .setDescription(`${sucessemoji} Purchased Bronze VIP For 3500 Coins`);
        ...
        let Embed2 = new Discord.MessageEmbed()
        .setColor("#FFFFFF")
        .setDescription(`${crossemoji} You need 600 coins to purchase some Nikes`);
      ...
      if (author < 600) return message.channel.send({embeds: [Embed2]})
        ...
        .setColor("#FFFFFF")
        .setDescription(`${sucessemoji} Purchased Fresh Nikes For 600 Coins`);
